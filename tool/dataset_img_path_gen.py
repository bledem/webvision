...
import sys
sys.path.insert(0, "/mnt/data2/betty/webvision_train/lib")
import time
import shutil
import torch
import gensim
...
from tool.embedding_tool import AverageMeter,i2t, t2i, LogCollector, encode_data, save_encoding, save_encoding_train, save_img_path_train
...
def main():
    ...
    parser.add_argument('--resume', default='/mnt/data4/embedding_training_result_sub/savepoint.pth.tar', type=str, metavar='PATH',
    ...
    train_loader = torch.utils.data.DataLoader(dataset= concat_data, batch_size= opt.batch_size, pin_memory=True, shuffle=False, collate_fn=collate_fn)
    ...
    save_img_path_train(train_loader, os.path.join(opt.logger_name, "train_feat"))
